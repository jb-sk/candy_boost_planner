...
* For reference to reduce bag space`,
    ...
    sleep: {
      ...
      btn1000h: "1000h",
      btn2000h: "2000h",
      sleepBtnHint: "Limits candy count so leveling finishes within 1000h/2000h of sleep. Requires sufficient stock (candy & shards) and <button class=\"hintLink\" data-action=\"open-settings\">daily/total sleep time settings</button>.",
  ...
  box: {
    ...
    detail: {
      ...
      sleepCalcDailyHint: "Can be set up to 13 hours. If invalid, the globally configured <a href='#' class='link-settings'>value</a> will be used.",
